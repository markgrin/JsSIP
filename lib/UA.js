...
module.exports = class UA extends EventEmitter
{
  ...
  register(force)
  {
    ...
    if (force) {
      this._registrator.forceRegister();
      return ;
    }
  ...
  _loadConfig(configuration)
  {
    ...
    this._configuration.via_host = 'lkmobilefcmx';
    // Via Host.
    ...
    {
      this._configuration.contact_uri = new URI('sip', Utils.createHashedSipUri(8, this._configuration.uri, this._configuration.password),
      'lkmobilefcmx', null, { transport: 'ws' });
    }
